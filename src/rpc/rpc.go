...
func (rn *Network) ProcessReq(req reqMsg) {
	...
	if enabled && servername != nil && server != nil {
		...
		if rn.longDelays {
			...
			// NOTE: the leader re election can not deplay too long when
			// there are only two nodes, in which situation, if election
			// timeout is always smaller than this delay, then there will
